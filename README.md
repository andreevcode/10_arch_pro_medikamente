...
[Вот диаграмма с архитектурой системы в модели C4](https://www.google.com/search?q=https://code.s3.yandex.net/software-architect/project10-landscape.drawio.xml%3F):
...
Хотите, чтобы я помог составить план выполнения этих задач или проанализировал требования к архитектуре?